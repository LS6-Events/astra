...
func TestPaths(t *testing.T) {
	...
	require.Equal(t, map[string]interface{}{"id": map[string]interface{}{"allOf": []interface{}{map[string]interface{}{"format": "uuid"}}, "type": "string"}, "name": map[string]interface{}{"type": "string"}, "photoUrls": map[string]interface{}{"allOf": []interface{}{map[string]interface{}{}, map[string]interface{}{"format": "uri"}}, "items": map[string]interface{}{"type": "string"}, "type": "array"}, "status": map[string]interface{}{"type": "string"}, "tags": map[string]interface{}{"items": map[string]interface{}{"$ref": "#/components/schemas/petstore.Tag"}, "type": "array"}}, schemas.Search("petstore.Pet", "properties").Data().(map[string]interface{}))
	...
	require.Equal(t, map[string]interface{}{"name": map[string]interface{}{"type": "string"}, "photoUrls": map[string]interface{}{"allOf": []interface{}{map[string]interface{}{}, map[string]interface{}{"format": "uri"}}, "items": map[string]interface{}{"type": "string"}, "type": "array"}, "status": map[string]interface{}{"type": "string"}, "tags": map[string]interface{}{"items": map[string]interface{}{"$ref": "#/components/schemas/petstore.Tag"}, "type": "array"}}, schemas.Search("petstore.PetDTO", "properties").Data().(map[string]interface{}))
